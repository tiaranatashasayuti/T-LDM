...
def extract_embedding(model, embeddings_loader, device, dataset_name):
    ...
    output_file = f"resulting_embeddings_final_{dataset_name}_test.pt"
...
def extract_embedding_pocket(model, embeddings_loader,device, dataset_name):
    ...
    output_file = f"resulting_embeddings_final_pocket_{dataset_name}_test.pt"
    torch.save(results_dict, output_file)
    print(f"Embeddings saved to {output_file}")
...
def main():
    ...
    torch.save(model.state_dict(), 'model_pretrained_coordinate_abalation_test.pth')
    ...
    torch.save(model.state_dict(), 'model_finetuned_coordinate_abalation_test.pth')
